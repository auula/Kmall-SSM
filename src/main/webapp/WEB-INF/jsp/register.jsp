			...
			<div class="login-cont w1200">
				<div class="form-box">
					<form class="layui-form" action="">
						<legend style="padding-top: 20px; padding-bottom: 20px;">用户注册</legend>
						<div class="layui-form-item">
							<div class="layui-inline but-div">
								<div class="layui-input-inline">
									<i class="layui-icon layui-icon-cellphone icon-input"></i> <input
										type=text name="email" id="email" lay-verify="required|email"
							...
							<div class="layui-inline but-div">
								<div class="layui-input-inline">
									<i class="layui-icon layui-icon-password icon-input"></i> <input
										type="password" name="password" id="password"
										lay-verify="required" placeholder="确定密码" autocomplete="off"
										class="layui-input">
								</div>
							</div>
